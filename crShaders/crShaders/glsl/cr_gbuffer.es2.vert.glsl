...
//varying vec3 sunDirection;  //the vertex normal transformed to our desired coordinate space for lighting calculations

//varying vec3 vertexTangent;
//varying mat3 TBN;
//varying output variables for passing to frag shaders
...
void main(void)
{
    ...
    //float jointIndexFloat0 = crVertexJointIndices[0];
    //float jointIndexFloat1 = crVertexJointIndices[1];
    //float jointIndexFloat2 = crVertexJointIndices[2];
    //float jointIndexFloat3 = crVertexJointIndices[3];
    ...
    vec4 vWorldPos = crModelMatrix * totalLocalPos;
